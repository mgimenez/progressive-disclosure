describe('Disclosure', function () {
    ...
    var Disclosure = window.Disclosure,
        _d = window._disclosures;

    describe('constructor', function () {
        it('should be defined', function () {
        	expect(typeof Disclosure).toEqual('function');
        });
    });
    ...
    describe('public properties', function () {
        ...
        it('should contain `wrapper`', function () {
            expect(disclosure.hasOwnProperty('wrapper')).toBeTruthy();
            expect(disclosure.wrapper.nodeType).toEqual(1);
        });

        it('should contain `event`', function () {
            expect(disclosure.hasOwnProperty('event')).toBeTruthy();
            expect(typeof disclosure.event).toEqual('string');
            expect(disclosure.event).toEqual('change');
        });

        it('should contain `container`', function () {
            expect(disclosure.hasOwnProperty('container')).toBeTruthy();
            expect(disclosure.container.nodeType).toEqual(1);
        });

        it('should contain `contents`', function () {
            expect(disclosure.hasOwnProperty('contents')).toBeTruthy();
            expect(typeof disclosure.contents).toEqual('object');
        });

        it('should contain `triggers`', function () {
            expect(disclosure.hasOwnProperty('triggers')).toBeTruthy();
            expect(typeof disclosure.triggers).toEqual('object');
        });

        it('should contain `lastTriggerShown`', function () {
            expect(disclosure.hasOwnProperty('lastTriggerShown')).toBeTruthy();
            expect(disclosure.lastTriggerShown.nodeType).toEqual(1);
        });

        it('should contain `lastContainerShown`', function () {
            expect(disclosure.hasOwnProperty('lastContainerShown')).toBeTruthy();
            expect(disclosure.lastContainerShown.nodeType).toEqual(1);
        });
    });
    ...
    describe('public methods', function () {
		...
		it('should contain `checkPreselectedTriggers`', function () {
			expect('checkPreselectedTriggers' in disclosure).toBeTruthy();
			expect(typeof disclosure.checkPreselectedTriggers).toEqual('function');
		});

        it('should contain `preloadAJAXContent`', function () {
            expect('preloadAJAXContent' in disclosure).toBeTruthy();
            expect(typeof disclosure.preloadAJAXContent).toEqual('function');
        });

        it('should contain `show`', function () {
            expect('show' in disclosure).toBeTruthy();
            expect(typeof disclosure.show).toEqual('function');
        });

        it('should contain `hide`', function () {
            expect('hide' in disclosure).toBeTruthy();
            expect(typeof disclosure.hide).toEqual('function');
        });

        it('should contain `isTrigger`', function () {
            expect('isTrigger' in disclosure).toBeTruthy();
            expect(typeof disclosure.isTrigger).toEqual('function');
        });

        it('should contain `loadAJAXContent`', function () {
            expect('loadAJAXContent' in disclosure).toBeTruthy();
            expect(typeof disclosure.loadAJAXContent).toEqual('function');
        });

        it('should contain `loadDOMContent`', function () {
            expect('loadDOMContent' in disclosure).toBeTruthy();
            expect(typeof disclosure.loadDOMContent).toEqual('function');
        });

        it('should contain `getContainer', function () {
            expect('getContainer' in disclosure).toBeTruthy();
            expect(typeof disclosure.getContainer).toEqual('function');
        });
    });

    describe('`wrapper` property', function () {
        var disclosure = _d[0];

        it('should have the `disclosure` boolean attribute', function () {
            expect(disclosure.wrapper.getAttribute('disclosure')).not.toEqual(null);
        });
    });
    ...
    describe('`container` property', function () {
        ...
        it('should be the one defined with `data-js` over the one defined with `id`', function () {
            expect(disclosure.container).toEqual(document.querySelector('[data-js="example0container"]'));
        });

        describe('not defined in a trigger', function () {
            it('should be the one defined in the wrapper', function () {
                var container = document.getElementById(disclosure.triggers[0].getAttribute('disclosure-container'));
                expect(disclosure.getContainer(disclosure.triggers[0])).toEqual(container);
            });
        });

        describe('defined in a trigger', function () {
            it('should be the one defined in a trigger', function () {
                expect(disclosure.getContainer(disclosure.triggers[1])).toEqual(disclosure.container);
            });
        });
    });
    ...
    describe('`event`', function () {
        ...
        it('should be `change` as default', function () {
            expect(_d[0].event).toEqual('change');
        });

        it('should be the same as defined in `disclosure-event` in wrapper', function () {
            expect(disclosure.event).toEqual(disclosure.wrapper.getAttribute('disclosure-event'));
        });
    });
